...
export async function renderPredict() {
  ...
  try {
    ...
    document.getElementById('home-team').innerHTML = '<option value="">Error loading teams</option>'
    document.getElementById('away-team').innerHTML = '<option value="">Error loading teams</option>'
    return
  }
        ...
        <div class="text-center mb-4">
          ...
          <div class="d-flex align-items-center justify-content-center gap-3 mb-3">
            <div class="text-center">
              <img src="${homeTeam?.crest_url || 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Association_football.svg/64px-Association_football.svg.png'}" 
            ...
            <div class="text-center">
              <img src="${awayTeam?.crest_url || 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Association_football.svg/64px-Association_football.svg.png'}" 
